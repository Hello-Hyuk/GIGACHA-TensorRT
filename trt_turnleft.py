...
from utils.yolo_classes_turnleft import get_cls_dict #turn_left_sign 
...
def parse_args():
    ...
    parser.add_argument(
        '-c', '--category_num', type=int, default=1, # turn_left has only one class
...
if __name__ == '__main__':
    ...
    pub = rospy.Publisher('/turn_left', Detection2DArray , queue_size=1) # create bbox msg 
