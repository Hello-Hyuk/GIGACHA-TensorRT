...
from utils.yolo_classes_traffic import get_cls_dict #traffic light has 8 classes
...
def parse_args():
    ...
    parser.add_argument(
        '-c', '--category_num', type=int, default=8, #traffic light has 8 classes
...
def main(publisher, publisher2):
    ...
    open_window(
        WINDOW_NAME, 'Traffic Light YOLOv4',
...
if __name__ == '__main__':
    rospy.init_node('Traffic_Light', anonymous=False) # create node
    pub = rospy.Publisher('/traffic_bbox', Detection2DArray , queue_size=1) # create bbox msg 
    pub2 = rospy.Publisher('/usb_cam/image_raw/fake', Image , queue_size=1) # create confs msg
    main(pub, pub2)
